...
- Default each worker/sub-agent to the best available model unless the user explicitly requested a different model, cheaper mode, faster mode, or runtime default.
